...
~~ Source Ahmed.AB For Supergroups 
...
git clone https://github.com/alobaidy98/ahmed.AB.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf ahmed.AB && rm -rf .telegram-cli && git clone https://github.com/alobaidy98/ahmed.AB.git && cd ahmed.AB && ./launch.sh install && ./launch.sh
~~~~~
